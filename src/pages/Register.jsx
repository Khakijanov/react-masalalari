    ...
    <div className={'grid grid-cols-1  lg:grid-cols-2 min-h-screen w-full bg-gray-400'}>
     <div className={'hidden  lg:grid lg:place-items-center'}>
      ...
      <div className={'grid place-items-center '}>
        ...
        <div>
        <button type='submit' className="btn  bg-black text-white hover:bg-transparent hover:text-black hover:border-black  btn-block">Sign up <span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
